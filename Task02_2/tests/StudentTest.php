...
class StudentTest extends TestCase
{
    ...
    {
        $s1 = new Student();
        $s1 -> setName("Nicolay") -> setLastName("Durnaev") -> setFaculty("FMiIT") -> setCourse(4) -> setGroup(402);
        $this -> assertSame(
            "Id: 1" . "\n" .
            "Фамилия: Durnaev" . "\n" .
            "Имя: Nicolay" . "\n" .
    ...
    public function testGetFuntions()
    {
        $s1 = new Student();
        $s1 -> setName("Nicolay") -> setLastName("Durnaev") -> setFaculty("FMiIT") -> setCourse(4) -> setGroup(402);
        $this ->  assertSame("Nicolay", $s1 -> getName());
        $this ->  assertSame("Durnaev", $s1 -> getLastName());
