...
class StudentsListTest extends TestCase
{
    ...
    public function testGet()
    {
        $student = new Student();
        $studentsList = new StudentsList();
        $student -> setName("Николай") -> setLastName("Дурнаев") -> setFaculty("ФМиИТ") -> setCourse(4) -> setGroup(402);
        $studentsList -> add($student);
    ...
    public function testCurrentAndKey()
    {
        ...
        $studentsList = new StudentsList();
        $student1 -> setName("Николай") -> setLastName("Дурнаев") -> setFaculty("ФМиИТ")-> setCourse(4) -> setGroup(402);
        $student2 -> setName("Иван") -> setLastName("Иванов") -> setFaculty("ИСИ") -> setCourse(2) -> setGroup(201);
        $student3 -> setName("Сергей") -> setLastName("Сергеев") -> setFaculty("ИФХ") -> setCourse(3) -> setGroup(303);
